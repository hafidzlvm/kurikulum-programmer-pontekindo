<?php 
require_once "controller/action_update.php";
?>
<!doctype html>
<html lang="en">
                  ...
                  <div class="card-body">
                    <div class="mb-3">
                      ...
                      <form action="" method="post">
                        ...
                        <input type="text"
                          class="form-control" name="jumlah" id="jumlah" aria-describedby="helpId" value="<?= $readOne->jumlah; ?>" required autofocus>
                        </div>
                        <button type="submit" name="Edit" class="btn btn-primary ">Submit</button>
                      </form>

                      <a name="back" id="back" class="btn btn-primary" href="index.php" role="button">Back</a> 
                    </div>
